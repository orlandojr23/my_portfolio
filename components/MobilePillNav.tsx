      ...
      >
        ...
        <div className="flex items-center pr-2">
          <a
            ...
            aria-label="Meet me"
          >
            <GoogleCalendarIcon className="h-[18px] w-[18px] opacity-90" aria-hidden="true" />
          </a>
          <a
            href={profile.github}
            target="_blank"
            ...
            aria-label="GitHub"
          >
            <GithubIcon className="h-[18px] w-[18px] opacity-90" aria-hidden="true" />
          </a>
          <a
            ...
            aria-label="LinkedIn"
          >
            <LinkedinIcon className="h-[18px] w-[18px] opacity-90" aria-hidden="true" />
          </a>
        </div>
      </nav>
    </>
